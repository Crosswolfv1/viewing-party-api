...
RSpec.describe 'Viewing Parties Endpoint' do
  before do
    ...
    @bad_user_id = 515_151
    @bad_party = 32_513_651
    @bad_invitees_param = { invitees_user_id: 3_503_503_503 }
  end
  ...
  describe 'create' do
    it 'can create a new entry' do
      ...
      post "/api/v1/viewing_parties/#{@user1.id}/users_viewing_party/#{party_created[:data][:id]}",
           params: @invitees_param
    ...
    it 'sad path: invalid user ID' do
      ...
      post "/api/v1/viewing_parties/#{@bad_user_id}/users_viewing_party/#{party_created[:data][:id]}",
           params: @invitees_param
